...
const OurValuesData = [
  ...
  {
    name: "الـمـرونـة",
    desc: "نحن نفهم أن عملائنا لديهم احتياجات مختلفة، وفريقنا علي استعداد لتلبية احتياجتهم بكل سهولة و مرونة.",
  ...
  return (
    <div>
      ...
      <TowSideLayout withEffect img="/home.jpg">
        ...
        >
          نقدم خـدمـات تعليمية و برمجية متقنة على اعلى مستوي
        </Typography>
